...
class EntriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create entry" do
    assert_difference("Entry.count") do
      post entries_url, params: { entry: { body_html: @entry.body_html, body_markdown: @entry.body_markdown, draft: @entry.draft, published_at: @entry.published_at, title: @entry.title } }
    end
